...
const InvoiceChart: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      <h3 className="text-xl font-semibold text-slate-200 mb-3">Invoice Overview</h3>
      {isLoading ? (
        <p className="text-center text-slate-400 py-8 text-base">Loading chart...</p>
      ) : error ? (
        <p className="text-center text-red-400 py-8 text-base">{error}</p>
      ) : (
